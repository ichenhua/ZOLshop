                ...
                <table class="insert-tab" width="100%">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" name="article_title" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th>作者：</th>
                            <td>
                                <input class="common-text required" name="article_author" size="20" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th>文章详情</th>
                            <td>
                                ...
                                <textarea name="article_content" style="width:98%;height:400px;visibility:hidden;"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th></th>
