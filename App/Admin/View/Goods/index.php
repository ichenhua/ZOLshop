            ...
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{U('GoodsStock/index',array('goods_id'=>$v['goods_id']))}}"> 库存 </a> <a href="{{U('edit',array('goods_id'=>$v['goods_id']))}}"> 修改 </a> <a href="{{U('add_is_delete',array('goods_id'=>$v['goods_id']))}}"> 下架 </a>
                        </td>
                    </tr>
                    <?php }?>
                </table>
